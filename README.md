# Changui ⚡ ARCHITECTURE-AWARE GIT HUD

**Changui** es una herramienta de interfaz de línea de comandos (CLI TUI) diseñada para desarrolladores que trabajan en Monorepos y proyectos con arquitectura en capas.
